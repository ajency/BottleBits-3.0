...
//expanding each block and slide product
...
//Showing different views(region, disterllery, details)
if ($(window).width() < 767) {
...
// From details page back to single view
...
(function() {
  ...
  if(el){
	...
	var currentLeft = 0;
	var currentTop = 0;
	var actheight = $(".product-sprite").height();
	var actwidth = $(".product-sprite").width();
	...
	zoomToggle.change(function() {
  	...
  	mc.on("pinch", function(ev) {
	    ...
	    //  currentScale * ev.scale +
	     // ")";
		proheight = $(".product-sprite").height() * currentScale * ev.scale;
		proWidth = $(".product-sprite").width()* currentScale * ev.scale;
...
$(".swipe-left-right").on("click", function(){
	$(this).addClass("hide");
    $('.scroll-up').removeClass("hide");
});
$(".scroll-up").on("click", function(){
	$(this).addClass("hide");
    $('.swipe-left-right').removeClass("hide");
});
